    ...
    sections: [
      {
        ...
        description: 'The “connected expertise” block under the hero video, including CenterFlow nodes.',
        fields: [
          f('eyebrow', 'Small label', 'United Properties'),
          f('heading', 'Heading', 'Connected expertise across every property service'),
          f(
            'description',
            'Supporting text',
            'From acquisition and sales to rentals and property management—one team linking you to Cyprus’s luxury market with clarity and continuity.',
            'textarea',
            3,
          ),
          f('node1_title', 'Node 1 title', 'Buy'),
          f('node1_phrase', 'Node 1 phrase', 'Find a property'),
          f('node2_title', 'Node 2 title', 'Rent'),
          f('node2_phrase', 'Node 2 phrase', 'Homes to lease'),
          f('node3_title', 'Node 3 title', 'Services'),
          f('node3_phrase', 'Node 3 phrase', 'Advisory & support'),
          f('node4_title', 'Node 4 title', 'Property'),
          f('node4_phrase', 'Node 4 phrase', 'Management'),
          f('node5_title', 'Node 5 title', 'About'),
          f('node5_phrase', 'Node 5 phrase', 'Our company'),
          f('node6_title', 'Node 6 title', 'Contact'),
          f('node6_phrase', 'Node 6 phrase', 'Get in touch'),
        ],
      },
      {
        id: 'featured',
